...
<script type="text/javascript">
	    ...
	    zhuge.track('reset-password-page');
	</script>
				...
				<div class="login-wrapper">
					<div class="box">
						<div class="content-wrap">
							<h6>重置密码</h6>
							<!-- <input id="user-email" class="form-control" type="text" placeholder="电子邮件地址">-->
							...
							<div class="action">
								<button id="resetpasswd-submit" type="button"
									class="btn btn-default signup">提交</button>
							</div>
						</div>
					</div>
				</div>
